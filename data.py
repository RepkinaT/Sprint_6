class Answers:
    ...
    ANSWER_5 = "Пока что нет! Но если что-то срочное — всегда можно позвонить в поддержку по красивому номеру " \
               "1010."
    ...
    ANSWER_7 = "Да, пока самокат не привезли. Штрафа не будет, объяснительной записки тоже не попросим. " \
               "Все же свои."
...
class DataOne:
    NAME = "Джон"
    SURNAME = "Смит"
    ADDRESS = "улица Авиамоторная 20"
    UNDERGROUND = "Бульвар Рокоссовского"
    TELEPHONE = "89995678598"
    DATE = "20.03.2024"
...
class DataTwo:
    NAME = "Михаэль"
    SURNAME = "Джонсон"
    ADDRESS = "улица Аргуновская 2"
    UNDERGROUND = "Сокольники"
    TELEPHONE = "89153697854"
    DATE = "20.03.2024"
